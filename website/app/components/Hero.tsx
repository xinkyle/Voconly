...
const GITEE_WINDOWS_DOWNLOAD_URL = 'https://gitee.com/xingkyle/Voconly/releases/download/v0.5.8/Voconly_0.5.8_x64-setup.exe';
const GITHUB_WINDOWS_DOWNLOAD_URL = 'https://github.com/xinkyle/Voconly/releases/download/v0.5.8/Voconly_0.5.8_x64-setup.exe';
